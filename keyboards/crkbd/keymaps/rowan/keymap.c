...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|-----------+------------+------------+------------+--------+--------|  |--------+--------+------------+------------+------------+------------|
                                                KC_LCTL,   LOWER, KC_LSFT,     KC_SPC,   RAISE,     KC_RALT
                                        //`------------------------------'  `------------------------------'
  ...
  /* Lower
   * ,-----------------------------------             -----------------------------------.
   * | TAB  |  ¬   |  _   |  -   |  £   |             | PGUP |   7  |   8  |   9  | BkSp |
   * |------+------+------+------+------+             +------+------+------+------+------|
   * | ESC  |  %   |  &   |  =   |  ~   |             | PGDN |   4  |   5  |   6  | Enter|
   * |------+------+------+------+------+             +------+------+------+------+------|
   * |   |  |  ;   |  :   |  +   |  *   |             |   0  |   1  |   2  |   3  |   .  |
   * |------+------+------+------+------+-------------+------+------+------+------+------|
   *                      | Ctrl | Lower| SHIFT| SPACE| Raise| CTRL |
   *                      -------------------------------------------
   */
  ...
  //|--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------|
      KC_NUBS, KC_LBRC, KC_RBRC,  KC_GRV, KC_CIRC,                      KC_SCLN, KC_COLN, KC_LABK, KC_RABK, KC_QUES,
  //|--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------|
                                 KC_LCTL,  ADJUST, KC_LSFT,     KC_SPC, _______, KC_RALT
                             //`--------------------------'  `--------------------------'
  ),

  [_ADJUST] = LAYOUT_split_3x5_3(
  //,--------------------------------------------.                    ,--------------------------------------------.
      QK_BOOT, KC_WH_U, KC_MS_U, KC_WH_D, KC_ACL2,                        KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,
  //|--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------|
      XXXXXXX, KC_MS_L, KC_MS_D, KC_MS_R, KC_ACL1,                        KC_F6, KC_BTN1, KC_BTN3, KC_BTN2,   KC_F7,
  //|--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------|
    CAPS_WORD, KC_WH_L, XXXXXXX, KC_WH_R, KC_ACL0,                        KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,
  //|--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------|
                                 KC_LCTL, _______, KC_LSFT,     KC_SPC, _______, KC_RALT
                             //`--------------------------'  `--------------------------'
  )
};
