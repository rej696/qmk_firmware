...
[_ALPHA1] = LAYOUT_ortho_4x12 ( \
  ...
  OSL(ALPHA2), GUI_T(KC_D), ALT_T(KC_T), CTL_T(KC_H), SFT_T(KC_E), KC_O, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
  OSL(PUNC), KC_Y, KC_S, KC_N, KC_I, KC_U, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
...
[_RAISE] = LAYOUT_ortho_4x12( \
  KC_DEL, KC_TAB, KC_HOME, KC_UP,   KC_END,   KC_PGUP, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
  KC_ESC, KC_ENT, KC_LEFT, KC_DOWN, KC_RIGHT, KC_PGDN, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  \
