...
/* Lower
 * ,-----------------------------------------------------------------------------------.
 * | DEL  | Home | Up   | End  |      |      |      |   7  |   8  |   9  |      | BkSp |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | ESC  | Left | Down | Right|      |      |      |   4  |   5  |   6  |   ,  | Enter|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Shift|PageUp|  INS |PageDn|      |      |      |   1  |   2  |   3  |   .  | Shift|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | CTRL |      | GUI  | Alt  | Lower| SPACE|  0   | Raise| Alt  | GUI  |ADJUST| CTRL |
 * `-----------------------------------------------------------------------------------'
 */
[_LOWER] = LAYOUT_ortho_4x12( \
  _______, KC_HOME, KC_UP,   KC_END,  XXXXXXX,  XXXXXXX, XXXXXXX, KC_7, KC_8, KC_9, XXXXXXX, _______, \
  KC_ESC, KC_LEFT, KC_DOWN, KC_RIGHT, XXXXXXX,  XXXXXXX, XXXXXXX, KC_4, KC_5, KC_6, KC_COMM, _______, \
  _______, KC_PGUP, KC_INS,  KC_PGDN, XXXXXXX,  XXXXXXX, XXXXXXX, KC_1, KC_2, KC_3, KC_DOT,  _______, \
...
[_RAISE] = LAYOUT_ortho_4x12( \
  _______, KC_EXLM, KC_LCBR,  KC_RCBR, KC_AT,   KC_NUBS, KC_SLSH, KC_MINS, KC_PERC, KC_AMPR,  KC_HASH, _______,  \
  KC_ESC,  KC_DQT,  KC_LPRN,  KC_RPRN, KC_QUOT, KC_NUHS, KC_UNDS, KC_EQL,  KC_LABK,  KC_RABK, KC_CLN,  _______, \
